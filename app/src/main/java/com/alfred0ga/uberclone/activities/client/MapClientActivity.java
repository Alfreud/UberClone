...
public class MapClientActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private void requestDriver() {
        if (mOriginLatLng != null && mDestinationLatLng != null) {
            ...
            intent.putExtra("Dest_lat", mDestinationLatLng.latitude);
            intent.putExtra("Dest_lng", mDestinationLatLng.longitude);
    ...
    private void instanceAutocompleteOrigin() {
        mAutocomplete = (AutocompleteSupportFragment) getSupportFragmentManager()
                .findFragmentById(R.id.places_autocomplete_origin);
    ...
    private void instanceAutocompleteDestination() {
        mAutocompleteDestination = (AutocompleteSupportFragment) getSupportFragmentManager()
                .findFragmentById(R.id.places_autocomplete_destination);
